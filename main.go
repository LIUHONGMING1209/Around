...
const (
	...
	POST_TYPE  = "post"
	DISTANCE   = "200km"
	ES_URL     = "http://104.196.165.127:9200"

	BUCKET_NAME     = "lhm-post-images"
...
func saveToBigTable(p *Post, id string) {
	...
	bt_client, err := bigtable.NewClient(ctx, "around-225905", "around-post", option.WithCredentialsFile("Around-57bfb66b7be9.json"))
	if err != nil {
		panic(err)
		return
	}
...
func saveToGCS(r io.Reader, bucketName, objectName string) (*storage.ObjectAttrs, error) {
	...
	// Creates a client.
	client, err := storage.NewClient(ctx, option.WithCredentialsFile("Around-57bfb66b7be9.json"))
	if err != nil {
		return nil, err
	}
...
// eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1NDcwOTk2MzYsInVzZXJuYW1lIjoiamFjayJ9.ztRvPS8hc2eZNjFhkvDTxiZ_IOtpkl0bTGaHc1aIDGQ
